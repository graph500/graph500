...
tree is -1.  Algorithm \ref{alg:kernel.3} provides a sample (and
inefficient) high-level implementation of [[#kernel3][Kernel 3]].
...
** Remarks
 ...
 - Edge weights are to be in the interval [1, maxweight].  We could also allow 0s.
